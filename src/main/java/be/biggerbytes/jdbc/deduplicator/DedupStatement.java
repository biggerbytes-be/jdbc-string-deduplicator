...
public class DedupStatement implements Statement {
    protected final Statement statement;
    protected final DedupContext context;

    private DedupStatement(Statement statement, DedupContext context) {
        this.statement = statement;
        this.context = context;
    }

    public static DedupStatement wrap(Statement statement, DedupContext context) {
        return new DedupStatement(statement, context);
    }

    public ResultSet executeQuery(String sql) throws SQLException {
        return DedupResultSet.wrap(statement.executeQuery(sql), context);
    }
